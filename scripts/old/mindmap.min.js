mindmap = (function() {
    ...
    function e() {
        ...
        for (var c = d.settings("bgcolors"), h = 0; h < a; h++) {
            ...
            var e = 0 == h ? "Root" : g + " " + h;
            $("#colorsdiv").append("<span class=s50>" + e + "</span>").append("<input class='bgcolors' id='color" + h + "' pickerNbr=" + h + " data-default-value=" + c[h] + " type=text value='" + c[h] + "'><br>")
        }
        $(".bgcolors").minicolors({
            textfield: !1,
            change: function(a, b) {
    ...
    function m(a) {
        try {
            ...
            1 == g.coloringMode ? ($("#mode1").addClass("active"), $("#mode2").removeClass("active")) : ($("#mode1").removeClass("active"), $("#mode2").addClass("active"));
            d.settings(g);
            render(!0);
    ...
    $(document).ready(function() {
        ...
        $(".coloringMode").on("touchstart click", function(a) {
            (a = $(this).attr("coloringMode")) || (a = 1);
            d.settings({
                coloringMode: a
            });
            e();
            $(".coloringMode").removeClass("active");
        ...
        return that = {
            ...
            newText: function(a) {
                var g = new Kinetic.Text({
                        ...
                        padding: Math.max(2, 3 - a.data.level),
                        align: "center"
                    }),
